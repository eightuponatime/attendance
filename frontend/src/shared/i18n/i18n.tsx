...
const messages = {
  ru: {
    ...
    "auth.title": "Рабочее время",
    "auth.text": "Войдите через корпоративный Google аккаунт",
  ...
  kk: {
    ...
    "auth.title": "Жұмыс уақыты",
    "auth.text": "Корпоративтік Google аккаунтымен кіріңіз",
  ...
  en: {
    ...
    "auth.title": "Working time",
    "auth.text": "Sign in with your corporate Google account",
